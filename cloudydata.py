...
cities = { "San_Francisco": '37.727239,-123.032229',
...
with con:
	...
	cur.execute('CREATE TABLE daily_temp ( day_of_reading INT, San_Francisco REAL, Seattle REAL, Philadelphia REAL, Denver REAL, Miami REAL)')
